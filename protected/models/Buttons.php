 ...
 * @property integer $but_id
 * @property string $but_name
 * @property string $but_image
 */
class Buttons extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('but_id',$this->but_id);
		$criteria->compare('but_name',$this->but_name,true);
		$criteria->compare('but_image',$this->but_image,true);
